...
export default function InformationComponent({
  ...
  return (
    <>
      <div
        className="col-span-10 col-start-2 row-start-3  uppercase text-[10px] leading-[28px] tracking-[2px] 
        flex justify-between 
       md:text-[13px] md:col-span-5 md:col-start-2 md:flex-col md:row-span-2 md:row-start-4 md:tracking-[2.6px]
 xl:col-start-3     "
      >
        <div>
          Current timezone<span className="md:hidden">:</span>
        </div>
        <div className="text-[15px] md:text-[40px] font-bold capitalize">
          {timezone}
        </div>
      </div>
...
xl:col-start-3"
      >
        <div>
          Day of the year<span className="md:hidden">:</span>
        </div>
        <div className="text-[15px] md:text-[40px] font-bold">{yearday}</div>
      </div>
      <div className="w-1 h-[75%] hidden xl:block xl:absolute bg-[#979797] bg-opacity-25 rounded-full left-0 right-0 mx-auto top-0 bottom-0 my-auto"></div>
      <div
...
"
      >
        <div>
          Day of the week<span className="md:hidden">:</span>
        </div>
...
"
      >
        <div>
          Week number<span className="md:hidden">:</span>
        </div>
