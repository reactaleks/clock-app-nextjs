...
export default function TimeComponent({currentTime, abbreviation, isExpanded}: PropTypes) {
    return (
        <div className={`text-[100px] md:text-[175px] font-bold leading-[100px] tracking-[-2.5px] 
        flex items-end
        ${isExpanded ? 'row-start-12 row-span-5 md:row-start-11' : 'row-start-15 row-span-4 md:row-start-16'}
